...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/content/final_malaria_full_class_classification_cropped', # The common prefix of both `ann_flie` and `data_prefix`.
        data_prefix='',  # The prefix of file paths in the `ann_file`, relative to the data_root.
        ann_file = "/content/final_malaria_full_class_classification_cropped/train_annotation.txt",
...
#         type='CustomDataset', #name of the dataset class,
#         #split = 'train',
#         data_root='/content/draft_data', # The common prefix of both `ann_flie` and `data_prefix`.
#         data_prefix='',  # The prefix of file paths in the `ann_file`, relative to the data_root.
#         with_label=True, # or False for unsupervised tasks
#         pipeline=train_pipeline, # The transformations to process the dataset samples.
#        ),
